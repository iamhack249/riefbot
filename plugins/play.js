...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, wm.trim(), await( await conn.getFile(thumbnail)).data, [['Video', `.ytv ${vid.url}`]], false, { quoted: m, 'document': { 'url':'https://youtube.com/@itsukabotz' },
...
title: wm,
body: `Sabar Cok...`,
sourceUrl: 'https://youtube.com/@itsukabotz', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
