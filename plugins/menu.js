...
%readmore`.trimStart(),
  ...
  footer: '',
  after: `bot masih dalam tahap pengembangan.
`,
}
...
// Tampilkan Tahun Baru
    ...
    let replace = {
      ...
      level, limit, name, weton, week, date, dateIslamic, dateCountdown, wib, wit, wita, time, totalreg, rtotalreg, role,
      readmore: readMore
    }
...
// Fake Contact
 const fcon = {
    ...
    let thumb = 'https://telegra.ph/file/e247941c104fc705ae652.jpg'
    let menu = [
    '🗿'
    ]
    ...
    conn.sendButton(m.chat, text.trim(),"RiefBotz", await (await fetch(thumb)).buffer(), [['Owner', '.owner'],['Donasi', '.donasi'],['Speed', '.speed']], true, { quoted: m })
